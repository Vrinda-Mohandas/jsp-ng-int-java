 ...
 */
@WebFilter("/ngui/*")
public class AngularFilter extends HttpFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (f.exists()) {
			...
			if (angularRootPath.equals("")) {
				...
				filterConfig.getServletContext().getRequestDispatcher(angularRootPath + "/index.html").forward(request,
						response);
			}
		}
		f = null;
